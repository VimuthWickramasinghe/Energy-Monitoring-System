    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-orange-100">
      ...
      <nav className="flex items-center justify-between px-8 py-4 bg-white border-b border-gray-100">
        ...
        <div className="flex items-center gap-6">
            <Link href="/auth" className="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 rounded-full text-sm font-medium transition-colors">
                Sign In
            </Link>
        </div>
    </nav>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          <div>
            ...
            <div className="flex items-center gap-4">
              <Link href="/auth/signup" className="bg-orange-500 hover:bg-orange-600 text-white px-7 py-3 rounded-full font-medium inline-flex items-center gap-2 transition-all hover:gap-3">
                Get Started
